	...
	function tipFill(what,op){
		var td = what.data(),
			...
			if(op['url']){
				...
				tipS.html(td.tipbody);
				if(td.tiphead){
					tipH.html(td.tiphead);
				}
			}
			else {
